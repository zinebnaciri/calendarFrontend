...
import { service } from './scenes/RouteComponent/Service';
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      service.saveToken(data.accessToken);
      service.saveRole(data.roles[0]);
      service.saveUsername(data.username);
      service.saveId(data.id);
